...
latest_data <- logged_data %>%
  rename(
    bus_time = names(logged_data)[2],  # Change to appropriate column name
    num_passengers = names(logged_data)[3],  # Change to appropriate column name
    travel_reason = names(logged_data)[4]  # Change to appropriate column name
  )
